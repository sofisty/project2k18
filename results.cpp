...
result* RadixHashJoin(relation *R, relation *S){
	...
	hist_node * R_head;
	R_head=(hist_node*)malloc(256* sizeof(hist_node));
	if (R_head == NULL) { fprintf(stderr, "Malloc failed \n"); return NULL;}
	

	psum_node* phead;
	phead=(psum_node*)malloc(256* sizeof(psum_node));
	...
	hist_node* S_head;
	S_head=(hist_node*)malloc(256* sizeof(hist_node));
	if (S_head == NULL) { fprintf(stderr, "Malloc failed \n"); return NULL;}
	

	psum_node* S_phead;
	S_phead=(psum_node*)malloc(256* sizeof(psum_node));
